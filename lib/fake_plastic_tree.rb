...
module FakePlasticTree
  class Gateway
    ...
    def self.prior_auth_capture(transaction_id, amount)
    ...
    def self.response_prior_auth_capture_success(transaction_to_capture, amount_to_capture)
      time = Time.now
    ...
    def self.response_prior_auth_capture_error(transaction_to_capture, amount_to_capture)
      amount = amount_to_capture
      transaction_id = transaction_to_capture
      {:api_error_response=>
               {:params=>
